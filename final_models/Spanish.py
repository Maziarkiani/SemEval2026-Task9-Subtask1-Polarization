...
OUTPUT_DIR = os.path.join(BASE_DIR, "submissions/spa_final")
MODEL_SAVE_DIR = os.path.join(BASE_DIR, "saved_models/Spanish")

os.makedirs(OUTPUT_DIR, exist_ok=True)
os.makedirs(MODEL_SAVE_DIR, exist_ok=True)

TRAIN_FILE = os.path.join(BASE_DIR, "merged/spa.csv")
TEST_FILE = os.path.join(BASE_DIR, "test/spa.csv")
...
def main():
    print("Starting Spanish Specialist Processing (mDeBERTa-v3)...")
    ...
    print("Saving final Spanish model...")
    ...
    pred_path = os.path.join(OUTPUT_DIR, "pred_spa.csv")
    pd.DataFrame({'id': df_test['id'], 'polarization': labels_final}).to_csv(pred_path, index=False)
    
    prob_path = os.path.join(OUTPUT_DIR, "probs_spa.csv")
