...
OUTPUT_DIR = os.path.join(BASE_DIR, "submissions/tel_final")
MODEL_SAVE_DIR = os.path.join(BASE_DIR, "saved_models/Telugu")

os.makedirs(OUTPUT_DIR, exist_ok=True)
os.makedirs(MODEL_SAVE_DIR, exist_ok=True)

TRAIN_FILE = os.path.join(BASE_DIR, "merged/tel.csv")
TEST_FILE = os.path.join(BASE_DIR, "test/tel.csv")
...
def main():
    print("Starting Telugu Specialist Processing (L3Cube-Telugu)...")
    ...
    print("Saving final Telugu model...")
    ...
    pred_path = os.path.join(OUTPUT_DIR, "pred_tel.csv")
    pd.DataFrame({'id': df_test['id'], 'polarization': labels_final}).to_csv(pred_path, index=False)
    
    prob_path = os.path.join(OUTPUT_DIR, "probs_tel.csv")
