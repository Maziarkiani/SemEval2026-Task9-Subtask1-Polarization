...
OUTPUT_DIR = os.path.join(BASE_DIR, "submissions/deu_final")
MODEL_SAVE_DIR = os.path.join(BASE_DIR, "saved_models/German")

os.makedirs(OUTPUT_DIR, exist_ok=True)
os.makedirs(MODEL_SAVE_DIR, exist_ok=True)

TRAIN_FILE = os.path.join(BASE_DIR, "merged/deu.csv")
TEST_FILE = os.path.join(BASE_DIR, "test/deu.csv")
...
def main():
    print("Starting German Specialist Processing (GBERT)...")
    ...
    print("Saving final German model...")
    ...
    pred_path = os.path.join(OUTPUT_DIR, "pred_deu.csv")
    pd.DataFrame({"id": df_test["id"], "polarization": labels_final}).to_csv(pred_path, index=False)

    probs_path = os.path.join(OUTPUT_DIR, "probs_deu.csv")
